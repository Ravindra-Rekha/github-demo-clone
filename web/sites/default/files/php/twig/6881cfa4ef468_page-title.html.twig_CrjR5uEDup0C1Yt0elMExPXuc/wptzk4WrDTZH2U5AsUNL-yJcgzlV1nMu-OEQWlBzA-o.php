...
class __TwigTemplate_63c941123b5820421701ce69ebc6bbd0 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (Twig\Extension\CoreExtension::trim(Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["title"] ?? null))))) {
            // line 17
            yield "<h1";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title_attributes"] ?? null), 17, $this->source), "html", null, true);
            yield ">";
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/content/page-title.html.twig", "C:\\xampp\\htdocs\\drupal_10\\web\\themes\\contrib\\bootstrap5\\templates\\content\\page-title.html.twig");
    }
