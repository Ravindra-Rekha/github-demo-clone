...
class __TwigTemplate_fc100e3f19204e568819973e792ba62f extends Template
{
    private $source;
    private $macros = [];
...
<span";
        ...
        yield ">";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["icon"] ?? null), 16, $this->source), "html", null, true);
        yield " ";
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["attributes", "icon", "link"]);        return; yield '';
    }
    ...
    {
        return array (  44 => 16,  40 => 15,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/contrib/bootstrap5/templates/field/file-link.html.twig", "C:\\xampp\\htdocs\\drupal_10\\web\\themes\\contrib\\bootstrap5\\templates\\field\\file-link.html.twig");
    }
